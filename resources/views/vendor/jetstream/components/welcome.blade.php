<div class="p-6 sm:px-20 bg-white border-b border-gray-200">
        ...
        <div class="d-flex flex-row">
            ...
            <h2 class="pt-2 ms-2">Sistema <b>Financiero</b> </h2>
        </div>


    <div class="mt-2 text-2xl">
       Bienvenido al sistema Finaciero ANF115!
    </div>
...
<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
    <div class="p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="https://laravel.com/docs">Subir Estado Financiero</a></div>
        </div>
        ...
        <div class="ml-12">
            ...
            <a href="https://laravel.com/docs">
                <div class="mt-3 flex items-center text-sm font-semibold text-indigo-700">
                        <div>Ver estados Financieros</div>
    ...
    <div class="p-6 border-t border-gray-200 md:border-t-0 md:border-l">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="https://laracasts.com">Calcular Ratios</a></div>
        </div>
    ...
    <div class="p-6 border-t border-gray-200">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="https://tailwindcss.com/">Comparar Ratios</a></div>
        </div>
